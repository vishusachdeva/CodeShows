...
border: 10px solid rgb(200, 200, 250);\
}\
";
...
exports.createSplitEditor = function(el) {
    ...
    split.resize = function resize(){
        var height = el.parentNode.clientHeight - el.offsetTop-el.offsetTop;
...
exports.bindCheckbox = function(id, callback, noInit) {
    ...
    var el = document.getElementById(id);
    if(id="select_style"||id=="folding"||id=="soft_wrap")return;
...
exports.bindDropdown = function(id, callback, noInit) {
	...
	if(id=="split"||id=="folding"||id=="soft_wrap")return;
    if (urlOptions[id])
